simfun_exp = function(n.subpops, burn.in.yrs, sim.yrs, clim.sd, move.mx, asp.mag, asp.effects, seeds){
    ...
    pop.size = 1000
    pop.vec.t0 = rep(pop.size/(3*n.subpops),3*n.subpops)
