...
# maxLam_by_climsd_df <- read_csv("seedSearchOutput/maxLam_2024-11-12 17:54:54.csv")
...
seed_climsd_df <- read_csv("seedSearchOutput/maxLam_2024-11-12 17:54:54.csv") %>% 
  rbind(.,read_csv("seedSearchOutput/maxLam_2024-12-05 08:53:32.csv")) %>% 
  group_by(asp.mag,clim.sd) %>% # For each clim.sd/asp.mag combination
...
move.mx <- moveMx_fun(n.subpops = n.subpops, data.frame(AtoB = 0.01, BtoA = 0.01))
