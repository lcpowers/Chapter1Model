...
for(i in 1:length(asp.effects)){
  ...
  tmp <- filter(S1_out_df,asp.effect == ae.i)
  write_csv(tmp,paste0("SimOutput/asp_effect_output/aspeff_",ae.i,"_2025-01-13.csv"))
...
df = filter(df,year>burn.in.yrs)
ggplot(df,aes(x=clim))+
