...
sim.yrs <- 200
reps <- 5
clim.sds <- seq(0,5,by=0.5);clim.sds[clim.sds==0] <- 0.001
asp.mags <- seq(0,5,by=0.25)
rhos <- seq(0,0.2,0.1)
...
# move.rate.i = 0
# asp.effects <- c(-1,1)
# move.mx <- moveMx_fun(n.subpops = 2,move.rate = move.rate.i)
...
out_df$asp.effect <- paste0("c(",S1_out_df$asp.effect,")")
